...
from recursive_early_stopping import train_model as recursive_split_train_model
from single_tree import train_model as ccp_pval_regularised_train_model
...
def main():
    reg = DecisionTreeRegressor(
        random_state=0, min_samples_split=50)

    # Example data
    X, y = sample_bemtpl16_data()
    d = X.shape[1]

    print(f"Data: n={X.shape[0]}, d={d}")
